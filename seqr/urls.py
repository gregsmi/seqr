...
from seqr.views.apis.pub_evidence_api import pub_evidence, pub_evidences, create_pub_evidence_note_handler, \
...
api_endpoints = {
    ...
    'pub_evidences': pub_evidences,
    'pub_evidence/(?P<gene_id>[^/]+)': pub_evidence,
