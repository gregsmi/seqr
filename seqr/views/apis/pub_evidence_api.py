...
@login_and_policies_required
def create_pub_evidence_gene_note_handler(request, gene_id):
    return { 'error': 'Not implemented'}


@login_and_policies_required
def create_pub_evidence_note_handler(request, pub_ev_id):
    return { 'error': 'Not implemented'}


@login_and_policies_required
def update_pub_evidence_note_handler(request, note_guid):
    return { 'error': 'Not implemented'}


@login_and_policies_required
def delete_pub_evidence_note_handler(request, note_guid):
    return { 'error': 'Not implemented'}
