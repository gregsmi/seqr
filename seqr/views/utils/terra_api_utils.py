...
from settings import SEQR_VERSION, TERRA_API_ROOT_URL, TERRA_PERMS_CACHE_EXPIRE_SECONDS, SERVICE_ACCOUNT_CREDENTIALS, \
    TERRA_WORKSPACE_CACHE_EXPIRE_SECONDS, SOCIAL_AUTH_AZUREAD_V2_TENANT_OAUTH2_KEY, SERVICE_ACCOUNT_FOR_ANVIL, SOCIAL_AUTH_PROVIDER
...
def google_auth_enabled():
    return bool(SOCIAL_AUTH_AZUREAD_V2_TENANT_OAUTH2_KEY)
