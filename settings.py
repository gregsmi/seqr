...
SEQR_ELASTICSEARCH_USER = os.environ.get('SEQR_ES_USER', 'seqr')
ELASTICSEARCH_CREDENTIALS = (SEQR_ELASTICSEARCH_USER, SEQR_ELASTICSEARCH_PASSWORD) if SEQR_ELASTICSEARCH_PASSWORD else None
